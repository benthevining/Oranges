...
#define @ORANGES_ARG_BASE_NAME@_MOBILE @ORANGES_MOBILE@
...
#define @ORANGES_ARG_BASE_NAME@_CRAY_COMPILER @ORANGES_CRAY_COMPILER@

#define @ORANGES_ARG_BASE_NAME@_ARM_COMPILER @ORANGES_ARM_COMPILER@

#define @ORANGES_ARG_BASE_NAME@_COMPILER_TYPE "@ORANGES_COMPILER_TYPE@"

#define @ORANGES_ARG_BASE_NAME@_COMPILER_VERSION "@ORANGES_COMPILER_VERSION@"
...
#define @ORANGES_ARG_BASE_NAME@_ARM_NEON @ORANGES_ARM_NEON@

#define @ORANGES_ARG_BASE_NAME@_AVX @ORANGES_AVX@
#define @ORANGES_ARG_BASE_NAME@_AVX512 @ORANGES_AVX512@

#define @ORANGES_ARG_BASE_NAME@_SSE @ORANGES_SSE@
