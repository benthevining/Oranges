...
find_file (
	original_dot_file deps_graph.dot PATHS "@PROJECT_SOURCE_DIR@"
...
if (NOT original_dot_file OR NOT EXISTS "${original_dot_file}")
	message (
		WARNING
			".dot input file ${original_dot_file} does not exist, image cannot be generated"
		)
...
execute_process (
	COMMAND "@ORANGES_DOT@" -Tpng -o "@ORANGES_DOC_OUTPUT_DIR@/deps_graph.png"
			"${original_dot_file}"
	WORKING_DIRECTORY "@ORANGES_DOC_OUTPUT_DIR@" COMMAND_ECHO STDOUT
