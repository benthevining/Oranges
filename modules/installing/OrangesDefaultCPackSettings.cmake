...
if (NOT APPLE AND NOT WIN32)
	set (CPACK_PACKAGE_NAME "${LOWER_PROJECT_NAME}"
		 CACHE STRING "Name of the CPack package")
else ()
	set (CPACK_PACKAGE_NAME "${PROJECT_NAME}" CACHE STRING
													"Name of the CPack package")
endif ()

# set (CPACK_PACKAGE_VENDOR "${${UPPER_PROJECT_NAME}_VENDOR}" CACHE STRING
# "CPack package vendor")

set (CPACK_PACKAGE_VERSION_MAJOR "${PROJECT_VERSION_MAJOR}"
	 CACHE STRING "CPack version major")
set (CPACK_PACKAGE_VERSION_MINOR "${PROJECT_VERSION_MINOR}"
	 CACHE STRING "CPack version minor")
set (CPACK_PACKAGE_VERSION_PATCH "${PROJECT_VERSION_PATCH}"
	 CACHE STRING "CPack version patch")
...
if (COMMON_PACKAGE_RELEASE)
	set (CPACK_PACKAGE_VERSION
		 "${CPACK_PACKAGE_VERSION}-${COMMON_PACKAGE_RELEASE}")
endif ()
...
# set (CPACK_PACKAGE_CONTACT "${${UPPER_PROJECT_NAME}_MAINTAINER}" CACHE STRING
# "CPack package maintainer contact")
...
elseif ((NOT CPACK_RESOURCE_FILE_LICENSE) OR (NOT EXISTS
...
elseif ((NOT CPACK_PACKAGE_DESCRIPTION_FILE)
		OR (NOT EXISTS "${CPACK_PACKAGE_DESCRIPTION_FILE}"))
	message (
		AUTHOR_WARNING
...
# Project") set(CPACK_NSIS_HELP_LINK
...
# set (CPACK_NSIS_MUI_ICON "${CPACK_PACKAGE_ICON}" CACHE PATH "CPack installer
# icon")

# set (CPACK_NSIS_MUI_UNIICON "${CPACK_PACKAGE_ICON}" CACHE PATH "CPack
# uninstaller icon")

# set (CPACK_NSIS_INSTALLED_ICON_NAME "${CPACK_PACKAGE_ICON}" CACHE PATH "Icon
# for the Windows 'Add or Remove Programs' tool")

set (CPACK_NSIS_HELP_LINK "${${PROJECT_NAME}_HOMEPAGE_URL}"
	 CACHE STRING "Adds project help link to registry")

# set (CPACK_NSIS_CONTACT "${CPACK_PACKAGE_CONTACT}" CACHE STRING "Package
# contact email")
...
# CPACK_DEBIAN_BUILD_DEPENDS CPACK_DEBIAN_PACKAGE_CONFLICTS
# CPACK_DEBIAN_PACKAGE_REPLACES CPACK_DEBIAN_PACKAGE_RECOMMENDS
...
# "${${UPPER_PROJECT_NAME}_PACKAGE_DEB_DEPENDS}" CACHE STRING "Deb package
# dependencies")
...
set (CPACK_RPM_PACKAGE_GROUP "Development/Libraries" CACHE STRING
														   "RPM package group")
...
set (CPACK_RPM_PACKAGE_URL "${${PROJECT_NAME}_HOMEPAGE_URL}"
	 CACHE STRING "RPM package homepage URL")

set (CPACK_RPM_PACKAGE_VERSION "${${PROJECT_NAME}_VERSION}"
	 CACHE STRING "RPM package version")

# set (CPACK_RPM_PACKAGE_REQUIRES "${${UPPER_PROJECT_NAME}_PACKAGE_RPM_DEPENDS}"
# CACHE STRING "RPM package dependencies")

set (CPACK_RPM_POST_INSTALL_SCRIPT_FILE
	 "${CMAKE_CURRENT_LIST_DIR}/scripts/rpmPostInstall.sh")

# #########################################################################################

set (config_file_output
	 "${CMAKE_CURRENT_BINARY_DIR}/generated/CPackConfig.cmake")

configure_file ("${CMAKE_CURRENT_LIST_DIR}/scripts/CPackConfig.cmake"
				"${config_file_output}" @ONLY)
